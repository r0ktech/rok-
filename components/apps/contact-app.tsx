...
export function ContactApp() {
  ...
  const socialLinks = [
    { name: "GitHub", url: "https://github.com/r0ktech", icon: "💻" },
    { name: "Twitter", url: "https://x.com/r0ktech", icon: "𝕏" },
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/r0ktech/",
      icon: "[in]",
    },
    { name: "Email", url: "mailto:raphaelokeke002@gmail.com", icon: "📩" },
  ];
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="space-y-4">
          ...
          <div className="bg-accent/10 border border-accent/30 rounded-lg p-3 text-center">
            ...
            <a
              href="mailto:raphaelokeke002@gmail.com"
              className="text-accent font-semibold hover:underline"
            >
              raphaelokeke002@gmail.com
            </a>
          </div>
        </div>
      </div>
