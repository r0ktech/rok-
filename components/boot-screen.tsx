  ...
  return (
    <div className="w-screen h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center relative z-10">
        ...
        <h1 className="text-5xl font-bold text-white mb-4 tracking-tight">Portfolio OS</h1>
        <p className="text-xl text-blue-200 mb-8 font-light">Loading your digital workspace...</p>
        
        {/* Loading bar */}
        <div className="w-64 h-2 bg-blue-900/50 rounded-full overflow-hidden border border-blue-400/30 mb-6">
          <div className="h-full bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full animate-pulse" style={{ width: '75%' }} />
        </div>
